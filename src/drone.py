...
class Drone(object):
    def __init__(self, message_rate=10, orgin=[22.9242595824972, 120.310152769089]):
        # stream rate service
    ...
    def gps_enu_callback(self, msg):
        ...
        "  Change coordinates to global coordinates related to GCS  "
        x, y, z = pm.enu2ecef(e_h, n_h, u_h , self.home[0], self.home[1], self.home[2])
        e, n, u = pm.ecef2enu(x, y, z, self.orgin[0], self.orgin[1], 0)
    ...
    def battery_callback(self, msg):
        volt = msg.voltage
        self.battery_perc = msg.percentage
    ...
    def guide_to_waypoint(self, waypoint, yaw=None):
        ...
        x, y, z = pm.enu2ecef(waypoint[0], waypoint[1], waypoint[2], self.orgin[0], self.orgin[1], 0)
    ...
    def position_control(self, wp_x, wp_y, wp_z):
        x, y, z = pm.enu2ecef(wp_x, wp_y, wp_z, self.orgin[0], self.orgin[1], 0)
        e, n, u = pm.ecef2enu(x, y, z, self.home[0], self.home[1], self.home[2])
